...
add_image_size( 'service', 400, 250, true );
...
if( function_exists('acf_add_options_page') ) {
	acf_add_options_page(array(
		'page_title' 	=> 'Переводы строк',
		'menu_title'	=> 'Переводы',
		'menu_slug' 	=> 'theme-general-stringeng',
		'capability'	=> 'edit_posts'
	));
}
/* end */
